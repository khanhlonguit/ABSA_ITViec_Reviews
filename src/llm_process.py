...
Sử dụng:
    python src/llm_process.py data/processed/100_review.csv
    python src/llm_process.py data/processed/100_review.csv --test 5
    python src/llm_process.py data/processed/100_review.csv --output result.csv --rerun
...
# ---------------------------------------------------------------------------
logging.basicConfig(
    filename=str(PROJECT_ROOT / "logs" / "llm_process_errors.log"),
    filemode="a",
